...
hi CursorLine       guisp=NONE guifg=#00FF87 guibg=#222727 ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
...
hi MatchParen       guisp=NONE guifg=#961582 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=bold
...
hi Search           guisp=NONE guifg=#00FF87 guibg=#18282E ctermfg=231 ctermbg=234 gui=NONE cterm=bold
hi SpecialKey       guisp=NONE guifg=#384545 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
hi SpellBad         guisp=NONE guifg=#3E6925 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
hi SpellCap         guisp=NONE guifg=#3E6925 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
hi SpellLocal       guisp=NONE guifg=#3E6925 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
hi SpellRare        guisp=NONE guifg=#3E6925 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
...
hi VisualNOS        guisp=NONE guifg=#00FF87 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
hi WarningMsg       guisp=NONE guifg=#00FF87 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
hi WildMenu         guisp=NONE guifg=#00FF87 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE

" major

hi Normal     guisp=NONE guifg=#23755A guibg=#101A1E ctermfg=145 ctermbg=235  gui=NONE   cterm=NONE
hi Comment    guisp=NONE guifg=#334740 guibg=#101A1E ctermfg=238 ctermbg=NONE gui=NONE cterm=NONE
hi Constant   guisp=NONE guifg=#644A7F guibg=NONE ctermfg=185 ctermbg=234  gui=NONE   cterm=bold
hi Identifier guisp=NONE guifg=#2FC079 guibg=NONE ctermfg=143 ctermbg=234  gui=NONE   cterm=bold
hi Statement  guisp=NONE guifg=#2FC079 guibg=NONE ctermfg=65  ctermbg=234  gui=NONE   cterm=NONE
hi PreProc    guisp=NONE guifg=#3F5242 guibg=NONE ctermfg=240 ctermbg=234  gui=NONE   cterm=bold
hi Type       guisp=NONE guifg=#82D967 guibg=NONE ctermfg=215 ctermbg=234  gui=NONE   cterm=bold
...
hi Todo       guisp=NONE guifg=#FAFF00 guibg=NONE ctermfg=168 ctermbg=234  gui=NONE   cterm=bold

" minor

hi String         guisp=NONE guifg=#50B45A guibg=NONE ctermfg=101 ctermbg=234 gui=NONE cterm=NONE
hi Character      guisp=NONE guifg=#83F558 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=bold
...
hi Function       guisp=NONE guifg=#28A475 guibg=NONE ctermfg=103 ctermbg=234 gui=NONE cterm=bold
...
hi Operator       guisp=NONE guifg=#644A7F guibg=NONE ctermfg=116 ctermbg=234 gui=NONE cterm=bold
hi Keyword        guisp=NONE guifg=#688060 guibg=NONE ctermfg=67  ctermbg=234 gui=NONE cterm=bold
"hi Keyword        guisp=NONE guifg=#644A7F guibg=NONE ctermfg=67  ctermbg=234 gui=NONE cterm=bold
hi Exception      guisp=NONE guifg=#A0EDA2 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
hi Include        guisp=NONE guifg=#678C61 guibg=NONE ctermfg=65  ctermbg=234 gui=NONE cterm=NONE
hi Define         guisp=NONE guifg=#6FC084 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
hi Macro          guisp=NONE guifg=#507350 guibg=NONE ctermfg=65  ctermbg=234 gui=NONE cterm=bold
...
hi Typedef        guisp=NONE guifg=#00FF00 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
hi SpecialChar    guisp=NONE guifg=#384545 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
hi Tag            guisp=NONE guifg=#00FF00 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
...
hi Debug          guisp=NONE guifg=#00FF00 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE

" Treesitter groups
" see https://github.com/nvim-treesitter/nvim-treesitter/blob/master/lua/nvim-treesitter/highlight.lua
" for highligh groups
hi TSAnnotation         guisp=NONE guifg=#4C5249 guibg=NONE    ctermfg=238 ctermbg=NONE gui=NONE cterm=NONE
hi TSNode               guisp=NONE guifg=#23755A guibg=#101A1E ctermfg=145 ctermbg=235  gui=NONE   cterm=NONE
...
hi TSConstMacro         guisp=NONE guifg=#409931 guibg=NONE ctermfg=141 ctermbg=234 gui=NONE cterm=NONE
hi TSFuncMacro          guisp=NONE guifg=#409931 guibg=NONE ctermfg=103 ctermbg=234 gui=NONE cterm=bold
hi TSConstBuiltin       guisp=NONE guifg=#409931 guibg=NONE ctermfg=141 ctermbg=234 gui=NONE cterm=NONE
hi TSConstructor        guisp=NONE guifg=#644A7F guibg=NONE ctermfg=141 ctermbg=234 gui=NONE cterm=NONE
hi TSField              guisp=NONE guifg=#347358 guibg=NONE ctermfg=141 ctermbg=234 gui=NONE cterm=NONE
hi TSAttribute          guisp=NONE guifg=#347358 guibg=NONE ctermfg=141 ctermbg=234 gui=NONE cterm=NONE
hi TSProperty           guisp=NONE guifg=#347358 guibg=NONE ctermfg=141 ctermbg=234 gui=NONE cterm=NONE
hi TSFuncBuiltin        guisp=NONE guifg=#409931 guibg=NONE ctermfg=103 ctermbg=234 gui=NONE cterm=bold
hi TSKeywordReturn      guisp=NONE guifg=#D2F990 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
hi TSKeywordOperator    guisp=NONE guifg=#00FF00 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
hi TSKeywordFunction    guisp=NONE guifg=#00FF00 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
"hi TSMethod             guisp=NONE guifg=#B0FF57 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
" TSMethod 36DA9B
hi TSMethod             guisp=NONE guifg=#347358 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
...
" bracket FFAF00
hi TSPunctBracket       guisp=NONE guifg=#7E6A00 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE  
...
hi TSText               guisp=NONE guifg=#64BB43 guibg=NONE ctermfg=101 ctermbg=234 gui=NONE cterm=NONE
hi TSTextStrong         guisp=NONE guifg=#83F558 guibg=NONE ctermfg=101 ctermbg=234 gui=NONE cterm=NONE
hi TSTextEmphasis       guisp=NONE guifg=#83F558 guibg=NONE ctermfg=101 ctermbg=234 gui=NONE cterm=NONE
