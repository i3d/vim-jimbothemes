...
let g:colors_name='ironman_dark'
set t_Co=256
...
hi IncSearch        guisp=NONE guifg=#BFAE75 guibg=#384545 ctermfg=231 ctermbg=234 gui=NONE cterm=bold
...
hi CursorLineNr     guisp=NONE guifg=#D20B04 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=bold
...
hi Search           guisp=NONE guifg=#BFAE75 guibg=#384545 ctermfg=231 ctermbg=234 gui=NONE cterm=bold
...
hi Visual           guisp=NONE guifg=NONE guibg=#211C1D ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
...
hi Normal     guisp=NONE guifg=#EFF8F9 guibg=#141112 ctermfg=145 ctermbg=235  gui=NONE cterm=NONE
hi Comment    guisp=NONE guifg=#514646 guibg=NONE ctermfg=238 ctermbg=NONE gui=NONE cterm=NONE
hi Constant   guisp=NONE guifg=#81ADAE guibg=NONE ctermfg=185 ctermbg=234  gui=NONE   cterm=bold
hi Identifier guisp=NONE guifg=#908381 guibg=NONE ctermfg=143 ctermbg=234  gui=NONE   cterm=bold
hi Statement  guisp=NONE guifg=#9C8463 guibg=NONE ctermfg=65  ctermbg=234  gui=NONE   cterm=NONE
hi PreProc    guisp=NONE guifg=#9C8463 guibg=NONE ctermfg=240 ctermbg=234  gui=NONE   cterm=bold
hi Type       guisp=NONE guifg=#7BE1E5 guibg=NONE ctermfg=215 ctermbg=234  gui=NONE   cterm=bold
hi Special    guisp=NONE guifg=#687181 guibg=NONE ctermfg=174 ctermbg=234  gui=NONE   cterm=bold
...
hi Todo       guisp=NONE guifg=#D20B04 guibg=NONE ctermfg=168 ctermbg=234  gui=NONE   cterm=bold

" minor

hi String         guisp=NONE guifg=#BFA068 guibg=NONE ctermfg=101 ctermbg=234 gui=NONE cterm=NONE
hi Character      guisp=NONE guifg=#BFA068 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=bold
hi Number         guisp=NONE guifg=#E6EA29 guibg=NONE ctermfg=121 ctermbg=234 gui=NONE cterm=bold
hi Boolean        guisp=NONE guifg=#E6EA29 guibg=NONE ctermfg=149 ctermbg=234 gui=NONE cterm=bold
hi Float          guisp=NONE guifg=#E6EA29 guibg=NONE ctermfg=32  ctermbg=235 gui=NONE cterm=bold
hi Function       guisp=NONE guifg=#DA2F21 guibg=NONE ctermfg=103 ctermbg=234 gui=NONE cterm=bold
hi Conditional    guisp=NONE guifg=#DA2F21 guibg=NONE ctermfg=67  ctermbg=234 gui=NONE cterm=NONE
hi Repeat         guisp=NONE guifg=#DA2F21 guibg=NONE ctermfg=32  ctermbg=234 gui=NONE cterm=NONE
hi Label          guisp=NONE guifg=#DA2F21 guibg=NONE ctermfg=32  ctermbg=234 gui=NONE cterm=bold
hi Operator       guisp=NONE guifg=#6F6E6D guibg=NONE ctermfg=116 ctermbg=234 gui=NONE cterm=bold
hi Keyword        guisp=NONE guifg=#B2880E guibg=NONE ctermfg=67  ctermbg=234 gui=NONE cterm=bold
...
hi Macro          guisp=NONE guifg=#EEDF79 guibg=NONE ctermfg=65  ctermbg=234 gui=NONE cterm=bold
...
hi Structure      guisp=NONE guifg=#C6BC53 guibg=NONE ctermfg=80  ctermbg=234 gui=NONE cterm=bold
hi Typedef        guisp=NONE guifg=#384545 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
hi SpecialChar    guisp=NONE guifg=#5AA7B4 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
hi Tag            guisp=NONE guifg=#5AA7B4 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
hi Delimiter      guisp=NONE guifg=#5AA7B4 guibg=NONE ctermfg=220 ctermbg=234 gui=NONE cterm=NONE
hi SpecialComment guisp=NONE guifg=#2C5659 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
hi Debug          guisp=NONE guifg=#5AA7B4 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
