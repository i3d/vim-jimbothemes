...
hi DiffAdd          guisp=NONE guifg=#4B4C4B guibg=NONE ctermfg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi DiffChange       guisp=NONE guifg=#4B4C4B guibg=NONE ctermfg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi DiffDelete       guisp=NONE guifg=#4B4C4B guibg=NONE ctermfg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi LineNr           guisp=NONE guifg=#191919 guibg=NONE ctermfg=NONE ctermbg=NONE gui=NONE cterm=bold
hi LineNrAbove      guisp=NONE guifg=#4B4C4B guibg=NONE ctermfg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LineNrBelow      guisp=NONE guifg=#4B4C4B guibg=NONE ctermfg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CursorLineNr     guisp=NONE guifg=#737373 guibg=NONE ctermfg=NONE ctermbg=NONE gui=NONE cterm=bold
"hi MatchParen       guisp=NONE guifg=#9CE667 guibg=NONE ctermfg=NONE ctermbg=NONE gui=NONE cterm=bold
hi MatchParen       guisp=NONE guifg=#D5D5D5 guibg=NONE ctermfg=NONE ctermbg=NONE gui=NONE cterm=bold
hi ModeMsg          guisp=NONE guifg=#4B4C4B guibg=NONE ctermfg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi MoreMsg          guisp=NONE guifg=#4B4C4B guibg=NONE ctermfg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi QuickFixLine     guisp=NONE guifg=#4B4C4B guibg=NONE ctermfg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi StatusLine       guisp=NONE guifg=#4B4C4B guibg=NONE ctermfg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Type       guisp=NONE guifg=#B2B2B2 guibg=NONE ctermfg=NONE ctermbg=NONE  gui=NONE   cterm=bold
...
hi Keyword        guisp=NONE guifg=#BABDBA guibg=NONE ctermfg=NONE  ctermbg=NONE gui=NONE cterm=bold
...
hi TSKeywordReturn      guisp=NONE guifg=#9F9F9F guibg=NONE ctermfg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
"hi TSMethod             guisp=NONE guifg=#4B4C4B guibg=NONE ctermfg=NONE ctermbg=NONE gui=NONE cterm=NONE
" TSMethod 36DA9B
