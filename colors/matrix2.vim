...
hi CursorLine       guisp=NONE guifg=NONE   guibg=#242A2A ctermfg=231 ctermbg=234 gui=bold cterm=bold
...
hi IncSearch        guisp=NONE guifg=#00FF87 guibg=#18282E ctermfg=231 ctermbg=234 gui=bold cterm=bold
...
hi CursorLineNr     guisp=NONE guifg=#84CA0B guibg=NONE ctermfg=231 ctermbg=234 gui=bold cterm=bold
hi MatchParen       guisp=NONE guifg=#9CE667 guibg=NONE ctermfg=231 ctermbg=234 gui=bold cterm=bold
...
hi Search           guisp=NONE guifg=#00FF87 guibg=#18282E ctermfg=231 ctermbg=234 gui=bold cterm=bold
...
hi Visual           guisp=NONE guifg=#00FF87 guibg=#18282E ctermfg=231 ctermbg=234 gui=bold cterm=bold
...
hi Constant   guisp=NONE guifg=#11FF25 guibg=NONE ctermfg=185 ctermbg=234  gui=bold cterm=bold
hi Identifier guisp=NONE guifg=#2CB37F guibg=NONE ctermfg=143 ctermbg=234  gui=bold cterm=bold
hi Statement  guisp=NONE guifg=#2CB37F guibg=NONE ctermfg=65  ctermbg=234  gui=NONE   cterm=NONE
hi PreProc    guisp=NONE guifg=#3F5242 guibg=NONE ctermfg=240 ctermbg=234  gui=bold cterm=bold
hi Type       guisp=NONE guifg=#89BE2E guibg=NONE ctermfg=215 ctermbg=234  gui=bold cterm=bold
...
hi Todo       guisp=NONE guifg=#DCFF00 guibg=NONE ctermfg=168 ctermbg=234  gui=bold cterm=bold
...
hi Number         guisp=NONE guifg=#11FF25 guibg=NONE ctermfg=121 ctermbg=234 gui=bold cterm=bold
hi Boolean        guisp=NONE guifg=#11FF25 guibg=NONE ctermfg=149 ctermbg=234 gui=bold cterm=bold
hi Float          guisp=NONE guifg=#11FF25 guibg=NONE ctermfg=32  ctermbg=235 gui=bold cterm=bold
hi Function       guisp=NONE guifg=#32CB90 guibg=NONE ctermfg=103 ctermbg=234 gui=bold cterm=bold
...
hi Label          guisp=NONE guifg=#81B32C guibg=NONE ctermfg=32  ctermbg=234 gui=bold cterm=bold
hi Operator       guisp=NONE guifg=#4F7E7E guibg=NONE ctermfg=116 ctermbg=234 gui=bold cterm=bold
hi Keyword        guisp=NONE guifg=#688060 guibg=NONE ctermfg=67  ctermbg=234 gui=bold cterm=bold
