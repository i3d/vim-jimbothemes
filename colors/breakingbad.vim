...
hi CursorLine       guisp=NONE guifg=#CDAD5A guibg=#212121 ctermfg=231 ctermbg=233 gui=NONE cterm=NONE
...
hi IncSearch        guisp=NONE guifg=#FFDC00 guibg=#2B2B2B ctermfg=231 ctermbg=234 gui=NONE cterm=bold
...
hi CursorLineNr     guisp=NONE guifg=#FFDC00 guibg=NONE ctermfg=231 ctermbg=234 gui=NONE cterm=bold
...
hi Search           guisp=NONE guifg=#FFDC00 guibg=#2B2B2B ctermfg=231 ctermbg=234 gui=NONE cterm=bold
...
hi Normal     guisp=NONE guifg=#A9A9A9 guibg=#1A1A1A ctermfg=145 ctermbg=235  gui=NONE cterm=NONE
hi Comment    guisp=NONE guifg=#555354 guibg=#1C1C1C ctermfg=238 ctermbg=NONE gui=NONE cterm=NONE
hi Constant   guisp=NONE guifg=#81ADAE guibg=NONE ctermfg=185 ctermbg=234  gui=NONE   cterm=bold
hi Identifier guisp=NONE guifg=#F1EFF0 guibg=NONE ctermfg=143 ctermbg=234  gui=NONE   cterm=bold
hi Statement  guisp=NONE guifg=#9F9A6E guibg=NONE ctermfg=65  ctermbg=234  gui=NONE   cterm=NONE
hi PreProc    guisp=NONE guifg=#7C7557 guibg=NONE ctermfg=240 ctermbg=234  gui=NONE   cterm=bold
...
hi Todo       guisp=NONE guifg=#F7E790 guibg=NONE ctermfg=168 ctermbg=234  gui=NONE   cterm=bold
...
hi Number         guisp=NONE guifg=#EDEDED guibg=NONE ctermfg=121 ctermbg=234 gui=NONE cterm=bold
hi Boolean        guisp=NONE guifg=#EDEDED guibg=NONE ctermfg=149 ctermbg=234 gui=NONE cterm=bold
hi Float          guisp=NONE guifg=#EDEDED guibg=NONE ctermfg=32  ctermbg=235 gui=NONE cterm=bold
hi Function       guisp=NONE guifg=#4B7F4C guibg=NONE ctermfg=103 ctermbg=234 gui=NONE cterm=bold
...
hi Label          guisp=NONE guifg=#305636 guibg=NONE ctermfg=32  ctermbg=234 gui=NONE cterm=bold
"hi Operator       guisp=NONE guifg=#81672B guibg=NONE ctermfg=116 ctermbg=234 gui=NONE cterm=bold
...
hi TSTypeBuiltin        guisp=NONE guifg=#D7B650 guibg=NONE ctermfg=215 ctermbg=234  gui=NONE   cterm=bold
"hi TSVariable           guisp=NONE guifg=#A9A9A9 guibg=NONE ctermfg=215 ctermbg=234  gui=NONE   cterm=bold
hi TSVariable           guisp=NONE guifg=#8B8B8B guibg=NONE ctermfg=215 ctermbg=234  gui=NONE   cterm=bold
hi TSVariableBuiltin    guisp=NONE guifg=#D7B650 guibg=NONE ctermfg=215 ctermbg=234  gui=NONE   cterm=bold
...
hi TSFuncMacro          guisp=NONE guifg=#478050 guibg=NONE ctermfg=103 ctermbg=234 gui=NONE cterm=bold
...
hi TSFuncBuiltin        guisp=NONE guifg=#D7B650 guibg=NONE ctermfg=103 ctermbg=234 gui=NONE cterm=bold
