...
hi CursorLine       guisp=NONE guifg=NONE  guibg=#262433 ctermfg=231 ctermbg=234 gui=bold cterm=bold
...
hi IncSearch        guisp=NONE guifg=#B38B67 guibg=#591719 ctermfg=231 ctermbg=234 gui=bold cterm=bold
hi LineNr           guisp=NONE guifg=#591719 guibg=NONE ctermfg=239 ctermbg=235 gui=bold cterm=bold
...
hi CursorLineNr     guisp=NONE guifg=#3074E5 guibg=NONE ctermfg=231 ctermbg=234 gui=bold cterm=bold
...
hi Search           guisp=NONE guifg=#B38B67 guibg=#591719 ctermfg=231 ctermbg=234 gui=bold cterm=bold
...
hi Visual           guisp=NONE guifg=NONE guibg=#1D1B26 ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
...
hi PreProc    guisp=NONE guifg=#1A3266 guibg=NONE ctermfg=240 ctermbg=234  gui=NONE   cterm=bold
...
hi Number         guisp=NONE guifg=#FDF2E2 guibg=NONE ctermfg=121 ctermbg=234 gui=bold cterm=bold
hi Boolean        guisp=NONE guifg=#FDF2E2 guibg=NONE ctermfg=149 ctermbg=234 gui=bold cterm=bold
hi Float          guisp=NONE guifg=#FDF2E2 guibg=NONE ctermfg=32  ctermbg=235 gui=bold cterm=bold
hi Function       guisp=NONE guifg=#FBC187 guibg=NONE ctermfg=103 ctermbg=234 gui=bold cterm=bold
...
hi Label          guisp=NONE guifg=#E3E3E3 guibg=NONE ctermfg=32  ctermbg=234 gui=bold cterm=bold
hi Operator       guisp=NONE guifg=#81672B guibg=NONE ctermfg=116 ctermbg=234 gui=bold cterm=bold
hi Keyword        guisp=NONE guifg=#274B99 guibg=NONE ctermfg=67  ctermbg=234 gui=bold cterm=bold
