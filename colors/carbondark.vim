...
hi CursorLine       guisp=NONE guifg=#606460 guibg=#131313 ctermfg=NONE ctermbg=NONE gui=bold cterm=bold
...
hi IncSearch        guisp=NONE guifg=#E2E500 guibg=#131313 ctermfg=NONE ctermbg=NONE gui=bold cterm=bold
...
hi CursorLineNr     guisp=NONE guifg=#CACACA guibg=NONE ctermfg=NONE ctermbg=NONE gui=bold cterm=bold
hi MatchParen       guisp=NONE guifg=#FAFAFA guibg=NONE ctermfg=NONE ctermbg=NONE gui=bold cterm=bold
...
hi PmenuSel         guisp=NONE guifg=#CACACA guibg=#131313 ctermfg=NONE ctermbg=NONE gui=bold cterm=bold
...
hi Search           guisp=NONE guifg=#E2E500 guibg=#131313 ctermfg=NONE ctermbg=NONE gui=bold cterm=bold
...
hi Constant   guisp=NONE guifg=#E42F2C guibg=NONE ctermfg=NONE ctermbg=NONE gui=bold cterm=bold
...
hi PreProc    guisp=NONE guifg=#3C3C3C guibg=NONE ctermfg=NONE ctermbg=NONE  gui=bold cterm=bold
hi Type       guisp=NONE guifg=#E6E6E6 guibg=NONE ctermfg=NONE ctermbg=NONE  gui=bold cterm=bold
...
hi Operator       guisp=NONE guifg=#E42F2C guibg=NONE ctermfg=NONE ctermbg=NONE gui=bold cterm=bold
...
hi Macro          guisp=NONE guifg=#7D7D7D guibg=NONE ctermfg=NONE  ctermbg=NONE gui=bold cterm=bold
...
hi Structure      guisp=NONE guifg=#7D7D7D guibg=NONE ctermfg=NONE  ctermbg=NONE gui=bold cterm=bold
...
hi Delimiter      guisp=NONE guifg=#E42F2C guibg=NONE ctermfg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSTypeBuiltin        guisp=NONE guifg=#4B4C4B guibg=NONE ctermfg=NONE ctermbg=NONE  gui=bold cterm=bold
" #[] as well.
hi TSVariable           guisp=NONE guifg=#535453 guibg=NONE ctermfg=NONE ctermbg=NONE gui=bold cterm=bold
hi TSVariableBuiltin    guisp=NONE guifg=#535453 guibg=NONE ctermfg=NONE ctermbg=NONE gui=bold cterm=bold
hi TSRepeat             guisp=NONE guifg=#929492 guibg=NONE ctermfg=NONE ctermbg=NONE gui=bold cterm=bold
hi TSConstant           guisp=NONE guifg=#CACACA guibg=NONE ctermfg=NONE ctermbg=NONE gui=bold cterm=bold
hi TSConstMacro         guisp=NONE guifg=#676767 guibg=NONE ctermfg=NONE ctermbg=NONE gui=bold cterm=bold
hi TSFuncMacro          guisp=NONE guifg=#676767 guibg=NONE ctermfg=NONE ctermbg=NONE gui=bold cterm=bold
hi TSConstBuiltin       guisp=NONE guifg=#676767 guibg=NONE ctermfg=NONE ctermbg=NONE gui=bold cterm=bold
...
hi TSFuncBuiltin        guisp=NONE guifg=#676767 guibg=NONE ctermfg=NONE ctermbg=NONE gui=bold cterm=bold
hi TSKeywordReturn      guisp=NONE guifg=#E6E6E6 guibg=NONE ctermfg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSKeywordOperator    guisp=NONE guifg=#E42F2C guibg=NONE ctermfg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSKeywordFunction    guisp=NONE guifg=#7D7F7D guibg=NONE ctermfg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSMethod             guisp=NONE guifg=#8F8F8F guibg=NONE ctermfg=NONE ctermbg=NONE gui=bold cterm=bold
...
hi TSTextStrong         guisp=NONE guifg=#9F9F9F guibg=NONE ctermfg=NONE ctermbg=NONE gui=bold cterm=bold
hi TSTextEmphasis       guisp=NONE guifg=#9F9F9F guibg=NONE ctermfg=NONE ctermbg=NONE gui=bold cterm=bold
