...
hi Search           guisp=NONE guifg=#D7B866 guibg=#647F4F ctermfg=231 ctermbg=234 gui=bold cterm=bold
...
hi Number         guisp=NONE guifg=#F1A534 guibg=NONE ctermfg=121 ctermbg=234 gui=bold cterm=bold
...
hi Function       guisp=NONE guifg=#E5C56C guibg=NONE ctermfg=103 ctermbg=234 gui=bold cterm=bold
