...
hi CursorLine       guisp=NONE guifg=NONE  guibg=#2B3333 ctermfg=231 ctermbg=234 gui=bold cterm=bold
...
hi IncSearch        guisp=NONE guifg=#A6641A guibg=#8BA654 ctermfg=231 ctermbg=234 gui=bold cterm=bold
...
hi CursorLineNr     guisp=NONE guifg=#839BB3 guibg=NONE ctermfg=231 ctermbg=234 gui=bold cterm=bold
...
hi Search           guisp=NONE guifg=#A6641A guibg=#8BA654 ctermfg=231 ctermbg=234 gui=bold cterm=bold
...
hi Visual           guisp=NONE guifg=NONE guibg=#2C2E2E ctermfg=231 ctermbg=234 gui=NONE cterm=NONE
...
hi Constant   guisp=NONE guifg=#e6d15a guibg=NONE ctermfg=185 ctermbg=234  gui=bold cterm=bold
hi Identifier guisp=NONE guifg=#80804B guibg=NONE ctermfg=143 ctermbg=234  gui=bold cterm=bold
hi Statement  guisp=NONE guifg=#565C46 guibg=NONE ctermfg=65  ctermbg=234  gui=bold cterm=NONE
hi PreProc    guisp=NONE guifg=#67692f guibg=NONE ctermfg=240 ctermbg=234  gui=bold cterm=bold
hi Type       guisp=NONE guifg=#625540 guibg=NONE ctermfg=215 ctermbg=234  gui=bold cterm=bold
hi Special    guisp=NONE guifg=#477340 guibg=NONE ctermfg=174 ctermbg=234  gui=bold cterm=bold
...
hi Todo       guisp=NONE guifg=#E34D84 guibg=NONE ctermfg=168 ctermbg=234  gui=bold cterm=bold

" minor

hi String         guisp=NONE guifg=#697258 guibg=NONE ctermfg=101 ctermbg=234 gui=NONE cterm=NONE
hi Character      guisp=NONE guifg=#384545 guibg=NONE ctermfg=231 ctermbg=234 gui=bold cterm=bold
hi Number         guisp=NONE guifg=#86f7a2 guibg=NONE ctermfg=121 ctermbg=234 gui=bold cterm=bold
hi Boolean        guisp=NONE guifg=#afd75f guibg=NONE ctermfg=149 ctermbg=234 gui=bold cterm=bold
hi Float          guisp=NONE guifg=#0087d7 guibg=NONE ctermfg=32  ctermbg=235 gui=bold cterm=bold
hi Function       guisp=NONE guifg=#849AB4 guibg=NONE ctermfg=103 ctermbg=234 gui=bold cterm=bold
...
hi Label          guisp=NONE guifg=#006080 guibg=NONE ctermfg=32  ctermbg=234 gui=bold cterm=bold
hi Operator       guisp=NONE guifg=#4F7E7E guibg=NONE ctermfg=116 ctermbg=234 gui=bold cterm=bold
hi Keyword        guisp=NONE guifg=#649498 guibg=NONE ctermfg=67  ctermbg=234 gui=bold cterm=bold
